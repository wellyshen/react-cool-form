...
React Cool Form combines these advantages and references the [UX theory](https://www.nngroup.com/articles/errors-forms-design-guidelines) of [Nielsen Norman Group](https://www.nngroup.com) as the basis for our [API](./docs/api-reference/use-form) design to help you beat all kinds of forms 👊🏻.
