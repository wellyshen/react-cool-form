...
:::note
The returned `fields` is an array of names. If you need to access the field's data, use the [watchState](../api-reference/use-form#watchstate) or [getState](../api-reference/use-form#getstate) methods.
:::
